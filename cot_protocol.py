...
class CoTEvent:
    ...
    def __init__(self,
        ...
        Args:
            ...
            meshtastic_short_name: Short display name extracted from the
                ``<meshtastic shortName="..."/>`` detail element (set by from_xml())
                or supplied by the caller for outgoing CoT.
        """
        self.uid = uid
    ...
    def to_xml(self) -> str:
        ...
        if self.is_meshtastic_node and self.callsign:
            ...
            mesh_elem.set("shortName", self.meshtastic_short_name or self.callsign[:4])
...
class CoTProtocolHandler:
    ...
    def marker_to_cot(marker: Dict[str, Any]) -> Optional[CoTEvent]:
        ...
        try:
            ...
            return CoTEvent(
                ...
                meshtastic_short_name=marker.get("shortName") or marker.get("short_name"),
            )
        except Exception as e:
    ...
    def cot_to_marker(cot_event: CoTEvent) -> Dict[str, Any]:
        ...
        #   • All other friendly contacts from ATAK with a human-derived "how"
        #     (h-g, h-e, etc.) are classified as tak_maker.
        ...
        # "node" so they render with the Meshtastic blue-circle icon instead of
        # a generic ground marker.
        ...
        return {
            ...
            "source": "cot",
            "how": cot_event.how,
            "shortName": cot_event.meshtastic_short_name or ""
        }
